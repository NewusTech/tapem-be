...
module.exports = {
  createMediaBanner: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(response(200, "success create Media Banner", mediaBannerCreate));
    } catch (error) {
  ...
  getMediaBanners: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(response(200, "success get Media Banner", mediaBanner));
    } catch (error) {
      logger.error(`Error : ${error}`);
      logger.error(`Error message: ${error.message}`);
  ...
  updateMediaBanner: async (req, res) => {
    try {
      ...
      res
        .status(200)
        .json(
          response(200, "success update Media Banner", MediaBannerAfterUpdate)
        );
    } catch (error) {
      logger.error(`Error : ${error}`);
      logger.error(`Error message: ${error.message}`);
